...
public:
    ...
    void ProcessMouseMovement(float xOff, float yOff, GLboolean constrainPitch = true);
...
inline void Camera::ProcessMouseMovement(float xOff, float yOff, GLboolean constrainPitch)
{
...
inline void Camera::ProcessMouseScroll(float yOff)
{
    Zoom -= yOff;
